...
function AGTest(outputLog) {
    ...
    var blockName = "name from contact: %";
    ...
    var input_1_2_1 = [["Betsy Anderson", "123 Main St. #4, New York NY 10001", "212-555-1234"]];
    ...
    var input_1_2_3 = [["John Smith", "50 First Lane", "435-9876"]];
    tip_1_2.newIOTest('r',  // testClass
        blockName,          // blockSpec
        input_1_2_3,        // input
        function (output) {
    ...
    var blockName = "address from contact: %";
    ...
    var input_2_2_1 = [["Betsy Anderson", "123 Main St. #4, New York NY 10001", "212-555-1234"]];
    tip_2_2.newIOTest('r',  // testClass
        ...
        function (output) {
            ...
            expected = "123 Main St. #4, New York NY 10001";
            if (output instanceof List) {
                actual = output.asArray();
            } else {
                actual = output;
    ...
    var input_2_2_3 = [["John Smith", "50 First Lane", "435-9876"]];
    tip_2_2.newIOTest('r',  // testClass
        blockName,          // blockSpec
        input_2_2_3,        // input
        function (output) {
    ...
    var blockName = "phone from contact: %";
    ...
    var tip_3_1 = chunk_3.newTip('Make sure you name your block exactly "' + blockName + '", place it in the scripting area.',
        'The "' + blockName + '" block exists.');
    ...
    var input_3_2_1 = [["Betsy Anderson", "123 Main St. #4, New York NY 10001", "212-555-1234"]];
    ...
    var input_3_2_3 = [["John Smith", "50 First Lane", "435-9876"]];
    tip_3_2.newIOTest('r',  // testClass
        blockName,          // blockSpec
        input_3_2_3,        // input
        function (output) {
